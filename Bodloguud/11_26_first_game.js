...
// }
// }
// const orolt = document.getElementById("orolt");
// // let hariult = document.getElementById("hariult");
// const submitBtn = document.getElementById("submit-btn");
...
//   if (orolt.value > randomNumber) {
//     hariult.innerHTML = "Tanii oruulsan utgaas baga too baina";
//   }
//   if (orolt.value < randomNumber) {
//     hariult.innerHTML = "Tanii oruulsan utgaas ikh too baina";
//   }

//   if (counter == 5) {
//     hariult.innerHTML =
//       "Ta niit 5 udaagiin oroldlogo hiisen bna. Uunees tsaash gazar ugui";
//     submitBtn.disabled = true;
//   }
//   if (randomNumber == orolt.value) {
//     hariult.innerHTML = "Bayr hurgey! Ta hojloo";
//   }
//   console.log(counter);
//   or.push(orolt.value);
//   console.log(or);
